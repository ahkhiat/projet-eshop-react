...
function Products() {
  ...
  const { products, isLoading, error } = useFetchProducts(categoryName);
  ...
  return (
    <div>
      <ProductGrid titre={`Produits pour la catégorie: ${categoryName || 'Tous les produits'}`} products={products} />
    </div>
  );
}
